  ...
  return (
    <div className="card card-side bg-base-100 border-2 border-[var(--primary-color)] w-[80%] mx-auto hover:shadow-2xl transition-all duration-300 cursor-pointer">
      ...
      <div className="card-body">
        ...
        {/* booking timings */}
        <div>
          <div className="flex justify-between items-center mt-8 w-[85%] px-2">
            <div>
              <p className="text-gray-400 font-medium">Departure Time</p>
              <p className="pt-[2px] text-lg font-bold">{departureTime}</p>
            </div>
            <span className="bg-[var(--primary-color)] h-[2px] w-[44px]"></span>
            <div>
        ...
        {/* bookings buttons */}
        <div className="w-[65%] grid grid-cols-2 gap-x-6 mt-5">
          <button
